...
const Publish = () => {
    ...
    const onFinish = (values) => {
        ...
        const reqData = {
            ...
            title: values.title,
            img_path: imgfileList[0].response.data,
            info: values.info,
            price: values.price,
        ...
        console.log(reqData);
        publishProductApi(reqData).then(res => {
            console.log(res);
        });
    ...
    return (
        <div className='block justify-center items-center'>
            ...
            <Form.Item>
                    <Button className=' left-10' type='primary' htmlType='submit' size='large' block>发布</Button>
            </Form.Item>
